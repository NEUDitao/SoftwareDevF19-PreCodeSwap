...
public interface IPlayerStrategy {
   ...
   */
  IAction strategizeInitMove(@NonNull List<ITile> hand, @NonNull Token avatar,
   ...
   */
  IAction strategizeIntermediateMove(@NonNull List<ITile> hand, @NonNull Token avatar,
